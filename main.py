...
import time
from data.CameraPoseDataset import CameraPoseDataset
from data.MSCameraPoseDataset import MSCameraPoseDataset
...
if __name__ == "__main__":
    ...
    # Create the model
    # model = torch.nn.DataParallel(get_model(args.model_name, args.backbone_path, config))
    # model.to(device)
    ...
    multiscene = get_model(args.model_name, args.backbone_path, config).classify_scene
    classify_scene = get_model(args.model_name, args.backbone_path, config).classify_scene
